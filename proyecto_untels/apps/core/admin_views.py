...
def admin_dashboard(request):
    ...
    informes_en_revision = Informe.objects.filter(estado=Informe.ESTADO_EN_REVISION).count()
    ...
    context = {
        ...
        'informes_en_revision': informes_en_revision,
...
def admin_reportes(request):
    ...
    informes_por_estado = {
        ...
        'en_revision': Informe.objects.filter(estado=Informe.ESTADO_EN_REVISION).count(),
...
def admin_revisar_informe(request, informe_id):
    ...
    # Cambiar estado a EN_REVISION_DOCENTE si está en OBSERVADO

...
- ✅ Validación automática con **IA** (Groq + fallback local)
...
```python
# Lo que sucede:
1. Alumno selecciona archivo .docx o .pdf
...
- `nombre_archivo`: "mi_informe.docx" o "mi_informe.pdf"
...
3. Envía todo a Groq con prompt específico
4. Groq devuelve JSON con observaciones:
   {
     "seccion": "Portada",
...
- Si NO hay observaciones → **OBSERVADO** (espera confirmación final del docente)
